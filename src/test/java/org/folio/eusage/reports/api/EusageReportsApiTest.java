    ...
    new EusageReportsApi(webClient).getCostPerUse(vertx, routingContext)
        .onComplete(context.asyncAssertSuccess(x -> {
          ...
          try {
            ...
            context.assertEquals("0.42", records.get(2).get(17));
            ...
            context.assertEquals("0.83", records.get(2).get(18));
  ...
  public void costPerUseFormatJournalJson(TestContext context) {
    ...
    new EusageReportsApi(webClient).getCostPerUse(vertx, routingContext)
        .onComplete(context.asyncAssertSuccess(x -> {
          ...
          assertThat(json.getJsonArray("items").getJsonObject(0).getDouble("costPerTotalRequest"), is(0.42));
          assertThat(json.getJsonArray("items").getJsonObject(0).getDouble("costPerUniqueRequest"), is(0.83));
          ...
          assertThat(json.getJsonArray("items").getJsonObject(2).getJsonArray("invoiceNumbers"), is(new JsonArray().add("i2")));
